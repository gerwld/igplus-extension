...
const initialState={disabled:!0,dark_mode:!1,disable_reels:!0,disable_explore:!0,counters_gray:!0,disable_vanity:!0,mp_disable_recs:!0,block_images:!1,block_videos:!1,square_shaped:!0,theme:"default",font:"default"},browser_cr=chrome||browser;function initStateIfNotExist(){browser_cr.storage.local.get("formState",e=>{e.formState&&0!==Object.keys(e.formState).length||browser_cr.storage.local.set({formState:{...initialState}})})}initStateIfNotExist(),browser_cr.runtime.onInstalled.addListener(function(){browser_cr.tabs.create({url:"https://chesscolibri.pro/welcome-ig"})}),browser_cr.runtime.setUninstallURL("https://docs.google.com/forms/d/e/1FAIpQLSckNi18UjnA6Zz_eVYMV5YnQXAa93-WsplVmmHIolpcbp0lXA/viewform?usp=sf_link");